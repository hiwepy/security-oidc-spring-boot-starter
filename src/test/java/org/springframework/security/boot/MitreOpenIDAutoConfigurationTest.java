...
class MitreOpenIDAutoConfigurationTest {
    ...
    void testInstantiation() {
        MitreOpenIDAutoConfiguration configuration = new MitreOpenIDAutoConfiguration();
    ...
    void testLoadsWhenEnabledPropertySet() {
        runner.withUserConfiguration(MitreOpenIDAutoConfiguration.class)
                .withPropertyValues("spring.boot.enabled=true")
                .run(context -> assertThat(context).hasSingleBean(MitreOpenIDAutoConfiguration.class));
    }
    ...
    void testNotLoadedWhenPropertyAbsent() {
        runner.withUserConfiguration(MitreOpenIDAutoConfiguration.class)
                .run(context -> assertThat(context).doesNotHaveBean(MitreOpenIDAutoConfiguration.class));
    }
}
