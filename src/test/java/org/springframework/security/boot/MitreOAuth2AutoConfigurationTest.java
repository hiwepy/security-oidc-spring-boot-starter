...
class MitreOAuth2AutoConfigurationTest {
    ...
    void testInstantiation() {
        MitreOAuth2AutoConfiguration configuration = new MitreOAuth2AutoConfiguration();
    ...
    void testLoadsWhenEnabledPropertySet() {
        runner.withUserConfiguration(MitreOAuth2AutoConfiguration.class)
                .withPropertyValues("spring.boot.enabled=true")
                .run(context -> assertThat(context).hasSingleBean(MitreOAuth2AutoConfiguration.class));
    }
    ...
    void testNotLoadedWhenPropertyAbsent() {
        runner.withUserConfiguration(MitreOAuth2AutoConfiguration.class)
                .run(context -> assertThat(context).doesNotHaveBean(MitreOAuth2AutoConfiguration.class));
    }
}
